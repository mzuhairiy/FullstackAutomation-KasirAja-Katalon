...
Mobile.startExistingApplication('com.kasirajaandroid', FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('General/Mobile/Close App'), [:], FailureHandling.STOP_ON_FAILURE)
